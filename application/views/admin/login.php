...
<div class="container">
	<div class="col-md-offset-4 col-md-4">
		<a onclick="pegawailogin()" class="lc" href="#"><div class="login-choose choose-kasir"><center> Login Admin</center></div></a>
		<div style="" id="kasir-login">
			<form method="POST" action="<?php echo site_url('admin/login') ?>" class="form-horizontal" role="form">
				<div class="form-group">
					<label for="inputEmail1" class="col-lg-3 control-label">Username</label>
					<div class="col-lg-9">
						<input type="text" name="input-email" class="form-control" id="inputEmail1" placeholder="Username">
					</div>
				</div>
				<div class="form-group">
